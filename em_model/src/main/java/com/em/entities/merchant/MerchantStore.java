package com.em.entities.merchant;

import com.em.entities.constants.MeasureUnit;
...
import com.em.utils.CloneUtils;
 ...
 */
@Entity
@Table(name = "MERCHANT_STORE", schema= SchemaConstant.EM_SCHEMA)
public class MerchantStore extends EMEntity<Integer, MerchantStore> {
